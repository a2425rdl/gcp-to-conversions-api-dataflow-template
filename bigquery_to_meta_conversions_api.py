...
from custom_sink import conversions_api_io
...
with beam.Pipeline(options=options) as pipeline:
    ...
    # read from BQ and write on Conversions API
    bqtocapi = (
        pipeline
        | 'Read from BigQuery' >> beam.io.ReadFromBigQuery(table=options.inputTableSpec)
